...
execute store result score #maxCheck netherite_fishing_rod_data run data get entity @s Motion[0] 180
...
execute store result score #maxCheck netherite_fishing_rod_data run data get entity @s Motion[1] 200
#scoreboard players operation #debug netherite_fishing_rod_data = #maxCheck netherite_fishing_rod_data
scoreboard players operation #maxCheck netherite_fishing_rod_data > #145 netherite_fishing_rod_data
scoreboard players operation #maxCheck netherite_fishing_rod_data < #900 netherite_fishing_rod_data
...
execute store result score #maxCheck netherite_fishing_rod_data run data get entity @s Motion[2] 180
scoreboard players operation #maxCheck netherite_fishing_rod_data < #900 netherite_fishing_rod_data
