...
execute store result score #maxCheck netherite_fishing_rod_data run data get entity @s Motion[0] 220
...
execute store result score #maxCheck netherite_fishing_rod_data run data get entity @s Motion[1] 130
scoreboard players operation #maxCheck netherite_fishing_rod_data < #900 netherite_fishing_rod_data
...
execute store result score #maxCheck netherite_fishing_rod_data run data get entity @s Motion[2] 220
scoreboard players operation #maxCheck netherite_fishing_rod_data < #900 netherite_fishing_rod_data
